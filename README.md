# prisma_alerts_csv_automation

This repository will automate the generation of the CSV report for Prisma alerts.
...
* Right click `alert_rule_csv_automation` and click `Execute Function Now...`
...
### API Calls made by generate_alert_csv.py
